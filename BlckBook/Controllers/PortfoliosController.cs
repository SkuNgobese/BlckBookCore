...
namespace BlckBook.Controllers
{
    public class PortfoliosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,TotalMark,CassContribution")] Portfolio portfolio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Description,TotalMark,CassContribution")] Portfolio portfolio)
        {
            if (id != portfolio.Id)
            {
                return NotFound();
